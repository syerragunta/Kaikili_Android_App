...
import com.sit.kaikiliService.camera.adapter.CameraBaseRecyclerViewAdapter;
 ...
 *
 */
public class Adapter_SelectedPhotoCamera extends CameraBaseRecyclerViewAdapter<Uri, Adapter_SelectedPhotoCamera.SelectedPhotoHolder> {
    ...
    public Adapter_SelectedPhotoCamera(ImagePickerActivity imagePickerActivity, int closeImageRes) {
