...
public class TextViewReadMoreEuphemiaUCASRegular extends TextView {
    ...
    public TextViewReadMoreEuphemiaUCASRegular(Context context) {
        super(context);
    ...
    public TextViewReadMoreEuphemiaUCASRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context);
    ...
    public TextViewReadMoreEuphemiaUCASRegular(Context context, AttributeSet attrs, int defStyle) {
